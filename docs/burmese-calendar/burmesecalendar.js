...
var burc = document.querySelector("#bur-c");
var lang = 1;
var x = new ceMmTranslate();
var mdt = new ceMmDateTime();
var ssy = "သာသနာနှစ်" + " " + x.T(mdt.ToMString("&YYYY"), lang);
var mmy = x.T(mdt.ToMString("&yyyy"), lang);
var mmm = x.T(mdt.ToMString("&M"), lang);
var mmd = x.T(mdt.ToMString("&P &f"), lang) + " " + "ရက်";
var dgh = "နဂါးခေါင်း " + " " + x.T(mdt.nagahle, lang) + " " + "လှည့်";
let yyz;
...
var mwd = mwda[mdt.w];
var astro = x.T(`${mdt.astro}`, lang);
var myDate = mmy + "  " + mmm + " " + mmd + " " + mwd + " " + yyz;
burc.textContent = myDate;

var engc = document.querySelector("#eng-c");
var td = new Date();
var today = td.toLocaleString("en-US", {
  year: "numeric",
  month: "short",
  day: "2-digit",
  weekday: "short",
});
engc.textContent = today;

setInterval(curtime, 1000);
function curtime() {
  var tdt = document.querySelector("#tdt");
  var td = new Date();
  tdt.innerHTML = td.toLocaleTimeString();
}

curtime();

// console.log(td.toLocaleTimeString());
// console.log(setInterval(tdtime(), 1000));
